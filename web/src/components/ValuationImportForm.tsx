...
const SCHEMA_FIELDS: { field: string; type: string; note: string }[] = [
  ...
  { field: "tier", type: "stringa", note: "fascia" },
  {
    field: "target",
    type: "numero ≥ 0",
    note: "prezzo obiettivo, su base 1000 crediti (i decimali vengono arrotondati)",
  },
  {
    field: "fair_value",
    type: "numero ≥ 0",
    note: "valore equo, su base 1000 crediti (i decimali vengono arrotondati)",
  },
  {
    field: "max_bid",
    type: "numero ≥ 0",
    note: "rilancio massimo suggerito, su base 1000 crediti (i decimali vengono arrotondati)",
  },
  {
    field: "panic_price",
    type: "numero ≥ 0",
    note: "soglia oltre cui non inseguire, su base 1000 crediti (i decimali vengono arrotondati)",
  },
